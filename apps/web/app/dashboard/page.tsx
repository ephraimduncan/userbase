                            ...
                            <AccordionItem className='border-none p-0 m-0' value="post">
                                ...
                                <AccordionContent className='p-0 m-0'>
                                    <div className='ml-5 pl-3 border-l border-l-muted-foreground/25 space-y-4 my-4'>
                                        <div className='cursor-pointer hover:underline'>Under Review</div>
                                        <div className='cursor-pointer hover:underline'>Planned</div>
                                        <div className='cursor-pointer hover:underline'>Active</div>
